...
public final class LedStrip {
    ...
    public void fillCountRGB(int start_led, int count, int r, int g, int b) { fillRangeRGB(start_led + LEDStart, start_led + count + LEDStart, r, g, b); }
    public void fillAllRGB(int r, int g, int b) { fillRangeRGB(LEDStart, LEDStart + LEDCount, r, g, b);}
    ...
    public void fillCountRGBGradient(int start_led, int count, int start_r, int start_g, int start_b, int end_r, int end_g, int end_b) { fillRangeRGBGradient(start_led + LEDStart, start_led + count + LEDStart, start_r, start_g, start_b, end_r, end_g, end_b); }
    public void fillAllRGBGradient(int start_r, int start_g, int start_b, int end_r, int end_g, int end_b) { fillRangeRGBGradient(LEDStart, LEDStart + LEDCount, start_r, start_g, start_b, end_r, end_g, end_b); }
